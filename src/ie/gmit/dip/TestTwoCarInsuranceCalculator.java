...
class TestTwoCarInsuranceCalculator {
	...
	@ParameterizedTest
	@CsvSource({ "600, 17, 0", "1175, 24, 5", "500, 26, 0", "550, 60, 1", "725, 20, 2" })
	@Timeout(value = 1000, unit = TimeUnit.MILLISECONDS)
	...
	@ParameterizedTest
	@CsvSource({ "100,18 ", "100, 23", "0, 50", "0, 25", "0, 35", "0, 50", "100, 19" })
	@Timeout(value = 1000, unit = TimeUnit.MILLISECONDS)
	...
	public static void SetUp() {
		System.out.println("The tests of TestTwoCarInsuranceCalculator are starting...");
	...
	public static void finalMessage() {
		System.out.println("All tests of TestTwoCarInsurnaceCalculator are done.");
